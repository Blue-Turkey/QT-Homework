...
constexpr auto qt_meta_stringdata_CLASSmainwindow1ENDCLASS = QtMocHelpers::stringData(
    "mainwindow1",
    "back",
    "",
...
void mainwindow1::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &mainwindow1::back; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
